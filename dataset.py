...
def generater(dataset_name, X_hsi, X_lidar, train_pixels, test_pixels, GT, batch_size, windowSize):
    #train_pixels, test_pixels = pixel_selection(GT, train_pixels)
    # data_path = '.\dataset\\' + dataset_name
    # x_train_hsi = sio.loadmat(os.path.join(data_path, 'HSI_Tr.mat'))['Data']
    # x_test_hsi = sio.loadmat(os.path.join(data_path, 'HSI_Te.mat'))['Data']
    # x_train_lidar = sio.loadmat(os.path.join(data_path, 'LIDAR_Tr.mat'))['Data']
    # x_test_lidar = sio.loadmat(os.path.join(data_path, 'LIDAR_Te.mat'))['Data']
    # y_train_hsi = sio.loadmat(os.path.join(data_path, 'TrLabel.mat'))['Data']
    #
    # y_train_hsi = y_train_hsi.squeeze()
    # y_test_hsi = sio.loadmat(os.path.join(data_path, 'TeLabel.mat'))['Data']
    # y_test_hsi = y_test_hsi.squeeze()
    ...
    # X_all_hsi, Y_all_hsi = get_image_cubes_all(input_data=X_hsi, pixels_select=GT, windowSize=windowSize)
    # X_all_lidar, Y_all_lidar = get_image_cubes_all(input_data=X_lidar, pixels_select=GT, windowSize=windowSize)
