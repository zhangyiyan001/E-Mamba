...
def get_ext():
    ...
    ext_modules.append(
        CUDAExtension(
            ...
            sources=[
                "csrc/selective_scan_mu/selective_scan_mu.cpp",
                "csrc/selective_scan_mu/selective_scan_core.cu",
                "csrc/selective_scan_mu/selective_scan_core_fwd2.cu",
                "csrc/selective_scan_mu/selective_scan_core_fwd3.cu",
                "csrc/selective_scan_mu/selective_scan_core_fwd4.cu",
            ],
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17"],
                "nvcc": [
            ...
            include_dirs=[Path(this_dir) / "csrc" / "selective_scan_mu"],
        )
    )
